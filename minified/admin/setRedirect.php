...
$redirectLink = isset($_POST['value'])? $_POST['value']: "";
...
if($redirectLink!='') {
    $db->query("update bots_settings set `value`='$redirectLink' where `key`='redirect';");
}
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading"><h3 class="panel-title">Set Redirect Link</h3></div>
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <form action="setRedirect.php" method="post">
                        <div class="table">
